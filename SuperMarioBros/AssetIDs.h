...
#define OBJECT_TYPE_MUSHROOM_GREEN 9
...
#define ID_SPRITE_BASE_PLATFORM_UNDER (ID_SPRITE_BASE_PLATFORM +4000)


#define ID_SPRITE_DECOR_BUSH 70000
#define	ID_SPRITE_DECOR_BUSH_BIG (ID_SPRITE_DECOR_BIG + 1000)
#define	ID_SPRITE_DECOR_BUSH_MEDIUM (ID_SPRITE_DECOR_BIG + 2000)
#define	ID_SPRITE_DECOR_BUSH_SMALL (ID_SPRITE_DECOR_BIG	+ 3000)
#define	ID_SPRITE_DECOR_BUSH_TINY (ID_SPRITE_DECOR_BIG	+ 4000)
